...
> = ({ children, className, indeterminate, inputClassName, style, ...rest }, ref) => (
  ...
  >
    <input
      className={[
        'border-primary-main flex min-h-5 min-w-5 cursor-pointer appearance-none items-center justify-center rounded-full border-2 bg-transparent outline-hidden focus:outline-2 focus:outline-offset-2 focus:outline-blue-500 disabled:cursor-not-allowed disabled:opacity-50',
        indeterminate
