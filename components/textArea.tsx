...
> = (
  ...
  return (
    ...
    >
      ...
      <textarea
        className={[
          'm-0 min-h-20 w-full rounded-md bg-slate-200 px-3 py-3 text-slate-900 outline-hidden transition-all focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-blue-500 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-slate-700 dark:text-slate-50',
          inputClassName,
        ]
          .filter(Boolean)
          .join(' ')}
